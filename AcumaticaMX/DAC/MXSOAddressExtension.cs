...
namespace AcumaticaMX
{
    public class MXSOAddressExtension : PXCacheExtension<PX.Objects.SO.SOBillingAddress>, IMXAddressExtension
    {
        ...
        [AddressPart(typeof(SOAddress.addressLine1), 1, typeof(street), typeof(extNumber), typeof(intNumber))]
        ...
        [PXString(50, IsUnicode = true)]
        [AddressPart(typeof(SOAddress.addressLine1), 2, typeof(street), typeof(extNumber), typeof(intNumber))]
        ...
        [PXString(50, IsUnicode = true)]
        [AddressPart(typeof(SOAddress.addressLine1), 3, typeof(street), typeof(extNumber), typeof(intNumber))]
        ...
        [PXString(50, IsUnicode = true)]
        [AddressPart(typeof(SOAddress.addressLine2), 1, typeof(neighborhood), typeof(municipality), Separator = ",")]
        ...
        [PXString(50, IsUnicode = true)]
        [AddressPart(typeof(SOAddress.addressLine2), 2, typeof(neighborhood), typeof(municipality), Separator = ",")]
        ...
        [AddressPart(typeof(SOAddress.addressLine3), 1, typeof(reference))]
