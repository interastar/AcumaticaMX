...
namespace AcumaticaMX
{
    public class MXAPAddressExtension : PXCacheExtension<PX.Objects.AP.APAddress>, IMXAddressExtension
    {
        ...
        [AddressPart(typeof(APAddress.addressLine1), 1, typeof(street), typeof(extNumber), typeof(intNumber))]
        ...
        [PXString(50, IsUnicode = true)]
        [AddressPart(typeof(APAddress.addressLine1), 2, typeof(street), typeof(extNumber), typeof(intNumber))]
        ...
        [PXString(50, IsUnicode = true)]
        [AddressPart(typeof(APAddress.addressLine1), 3, typeof(street), typeof(extNumber), typeof(intNumber))]
        ...
        [PXString(50, IsUnicode = true)]
        [AddressPart(typeof(APAddress.addressLine2), 1, typeof(neighborhood), typeof(municipality), Separator = ",")]
        ...
        [PXString(50, IsUnicode = true)]
        [AddressPart(typeof(APAddress.addressLine2), 2, typeof(neighborhood), typeof(municipality), Separator = ",")]
        ...
        [AddressPart(typeof(APAddress.addressLine3), 1, typeof(reference))]
