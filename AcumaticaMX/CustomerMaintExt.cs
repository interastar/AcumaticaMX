    ...
    public class CustomerMaintExt : PXGraphExtension<CustomerMaint>
    {
        ...
        protected virtual void Customer_RowPersisting(PXCache sender, PXRowPersistingEventArgs e, PXRowPersisting InvokeBaseHandler)
        {
            ...
            if (e.Operation == PXDBOperation.Update || e.Operation == PXDBOperation.Insert)
            {
                ...
                SYFEBAccountExt customerExt = customer.GetExtension<SYFEBAccountExt>();
                ...
                if (natural)
                {
                    ...
                    var contactExt = contact?.GetExtension<SYFEContactExt>();
                    ...
                    if (string.IsNullOrEmpty(contactExt?.FirstLastName))
                    {
                        ...
                        cache.RaiseExceptionHandling<SYFEContactExt.firstLastName>(
                    ...
                    if (string.IsNullOrEmpty(contactExt?.SecondLastName))
                    {
                        ...
                        cache.RaiseExceptionHandling<SYFEContactExt.secondLastName>(
                ...
                var addressExt = address?.GetExtension<SYFEAddressExt>();

                if (string.IsNullOrEmpty(addressExt?.Street))
                {
                    e.Cancel = true;

                    cache.RaiseExceptionHandling<SYFEAddressExt.street>(
                ...
                if (string.IsNullOrEmpty(addressExt?.ExtNumber))
                {
                    ...
                    cache.RaiseExceptionHandling<SYFEAddressExt.extNumber>(
                ...
                if (string.IsNullOrEmpty(addressExt?.Neighborhood))
                {
                    ...
                    cache.RaiseExceptionHandling<SYFEAddressExt.neighborhood>(
                ...
                if (string.IsNullOrEmpty(addressExt?.Municipality))
                {
                    ...
                    cache.RaiseExceptionHandling<SYFEAddressExt.municipality>(
        ...
        protected virtual void UpdateContactFields(Customer customer)
        {
            ...
            PXUIFieldAttribute.SetVisible<SYFEContactExt.firstLastName>(Base.DefContact.Cache, null, natural);
            PXUIFieldAttribute.SetVisible<SYFEContactExt.secondLastName>(Base.DefContact.Cache, null, natural);
            PXUIFieldAttribute.SetVisible<SYFEContactExt.personalID>(Base.DefContact.Cache, null, natural);
            ...
            PXUIFieldAttribute.SetVisible<SYFEContactExt.firstLastName>(Base.BillContact.Cache, null, natural);
            PXUIFieldAttribute.SetVisible<SYFEContactExt.secondLastName>(Base.BillContact.Cache, null, natural);
            PXUIFieldAttribute.SetVisible<SYFEContactExt.personalID>(Base.BillContact.Cache, null, natural);
        }
