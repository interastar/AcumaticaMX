If Exists (Select * From sys.objects Where object_id = OBJECT_ID(N'[SYFEAPRegisterExt]') And type in (N'U'))
	Drop Table [SYFEAPRegisterExt]
Go

/****** Object:  Table [dbo].[SYFEAPRegisterExt] ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[SYFEAPRegisterExt](
	...
	-- Datos de Validación
	[IsImport]			BIT NULL DEFAULT ((1)),
	[Provider]			[nvarchar](13) NULL,
	[TaxesTotal]		DECIMAL(19, 4) NULL,
	[AmountTotal]		DECIMAL(19, 4) NULL,

	CONSTRAINT [SYFEAPRegisterExt_PK] PRIMARY KEY CLUSTERED 
	(
		[CompanyID] ASC,
		[DocType] ASC,
		[RefNbr] ASC
